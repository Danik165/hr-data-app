        ...
        if (userData.data.length === 0) {
            return (
                <div>
                    ...
                    <p>Adding skills to your profile helps us provide better recommendations and improves your overall experience on the platform.</p>
                    <p>Start by adding a new skill in your profile settings. If you are not sure what to add, explore the platform to see what others are learning and sharing.</p>
                </div>
            );
        } else {
            let totalYears = 0;
            ...
            return (
                <div>
                    ...
                    {Object.entries(userCategories).map(([category, count]) => (
                        <p key={category}>{category}: {count} skills (Overall: {popularCategories[category] || 0} skills)</p>
                    ))}
                </div>
            );
        }
