        ...
        >
          <CDBCardBody className="mx-4">
            ...
            <CDBInput
              ...
              onChange={(e) =>
                setNewProfile({ ...newProfile, employeeId: e.target.value })
              }
            />
            <CDBInput
              style={{ "border-radius": "0px" }}
            ...
            <CDBInput
              ...
              iconClass="text-muted"
              onChange={(e) =>
                setNewProfile({ ...newProfile, confirmEmail: e.target.value })
              }
            />
            ...
            <CDBInput
              ...
              iconClass="text-muted"
              onChange={(e) =>
                setNewProfile({ ...newProfile, city: e.target.value })
              }
            />
            <CDBInput
              style={{ "border-radius": "0px" }}
              ...
              iconClass="text-muted"
              onChange={(e) =>
                setNewProfile({ ...newProfile, state: e.target.value })
              }
            />
            ...
            <select
              ...
              onChange={(e) =>
                setNewProfile({ ...newProfile, roleId: e.target.value })
              }
            >
              {roles.map((role) => (
                <option id={role.roleID} value={role.roleID}>
                  {role.RoleName}
                </option>
              ))}
            </select>
            ...
            <select
              id="worktype"
              name="worktype"
              className="worktype-dropdown"
              onChange={(e) =>
                setNewProfile({ ...newProfile, worktype: e.target.value })
              }
            >
              <option id="1" value="WFH">
                Work From Home
              </option>
              <option id="2" value="WFO">
                Work From Office
              </option>
              <option id="3" value="Hybrid">
                Hybrid
              </option>
            </select>
            ...
            <select
              ...
              onChange={(e) =>
                setNewProfile({ ...newProfile, workstatus: e.target.value })
              }
            >
              <option id="1" value="Salaried">
                Salaried
              </option>
              <option id="2" value="Contract">
                Contract
              </option>
            ...
            <select
              ...
              onChange={(e) =>
                setNewProfile({ ...newProfile, managerID: e.target.value })
              }
            >
              <option id="sel" value={0}>
                Select a Manager
              </option>
              {managerList.map((manager) => (
                <option id={manager.employeeId} value={manager.employeeId}>
                  {manager.Name}
                </option>
              ))}
            </select>
            ...
            <input
              ...
              pattern="\d{4}-\d{2}-\d{2}"
              onChange={(e) =>
                setNewProfile({ ...newProfile, DOB: e.target.value })
              }
            />
            <br />
            ...
            <input
              ...
              pattern="\d{4}-\d{2}-\d{2}"
              onChange={(e) =>
                setNewProfile({ ...newProfile, joiningDate: e.target.value })
              }
            />
            <br />
